...
public class BoardController {
	...
	public String selectNoticeList (DefaultVO vo, ModelMap model) throws Exception {
		...
		int total = boardService.selectNoticeTotal(vo);
		...
		List<?> list = boardService.selectNoticeList(vo);
	...
	public String selectNoticeDetail( String unq
									,ModelMap model) throws Exception {
		...
		// 상세보기  
		NoticeVO vo = boardService.selectNoticeDetail(unq);
