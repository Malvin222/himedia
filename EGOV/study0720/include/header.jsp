...
<div id= "hd" style="z-index: 1000; margin: 0 auto;">
            <div style="width: 100%; background-color: #f9f9f9; border-bottom: #ddd 1px solid;">
                <div style="width: 1000px; margin:0 auto; height: 35px; line-height: 35px;">
                    <ul style="float: left;">
                        <li class="li_style"><a class="li_left_style" href ="../main/main.jsp" style="padding: 0 20px; display: inline; font-size: 11px;"> HOME </a></li>
                    ...
                    <ul style='float:right;'>
                        ...
                        <li class="li_style"><a class="a_li_style" href="../board/noticeList.jsp">공지사항</a></li>
            ...
            <div id="hd_wrapper">
                <div style="width: 100%; height: 80px;">
                    ...
                    <div id="hd_wrapper_main_title">
                        <a href="../main/main.jsp"> <img src="../images/logo_img.jpg" alt="제주렌트카"> </a>
                    </div>
