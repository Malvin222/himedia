...
<!DOCTYPE html>
로그인아이디 ${sessionScope.SessionUserID}
...
<div id= "hd" style="z-index: 1000; margin: 0 auto;">
            <div style="width: 100%; background-color: #f9f9f9; border-bottom: #ddd 1px solid;">
                <div style="width: 1000px; margin:0 auto; height: 35px; line-height: 35px;">
                    <ul style="float: left;">
                        <li class="li_style"><a class="li_left_style" href ="../main.do" style="padding: 0 20px; display: inline; font-size: 11px;"> HOME </a></li>
                    ...
                    <ul style='float:right;'>
                        ...
                        <li class="li_style"><a class="a_li_style" href="../mbrConditions.do">회원가입</a></li>
                        <li class="li_style"><a class="a_li_style" href="../loginWrite.do"><b>로그인</b></a></li>
                        
                        </c:if>
                        
                        <c:if test="${s_userid !=null }">
                        <li class="li_style"><a class="a_li_style" href="/mbrModify.do"><b>정보수정</b></a></li>
                        <li class="li_style"><a class="a_li_style" href="javascript:fn_logout()"><b>로그아웃</b></a></li>
                        </c:if>
            ...
            <div id="hd_wrapper">
                <div style="width: 100%; height: 80px;">
                    ...
                    <div id="hd_wrapper_main_title">
                        <a href="/"> <img src="../images/logo_img.jpg" alt="제주렌트카"> </a>
                    </div>
